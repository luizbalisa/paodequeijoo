 ...
 * @author Rafael
 */
public class JDialogFornecedores2 extends javax.swing.JDialog {

    JPanelContasPagar contaPagar;

    /**
     * Creates new form JDialogFornecedores
     */
    public JDialogFornecedores2(java.awt.Frame parent, boolean modal, JPanelContasPagar venda) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        preencherFornecedores();
        buscaDinamica();
        this.contaPagar = venda;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTable1.getSelectedRow() == -1) {
            ...
            contaPagar.setFornecedor(f.getFornecedor());
            this.dispose();
        }
