 ...
 * @author Rafael
 */
public class JDialogProdutosProducao extends javax.swing.JDialog {

    JPanelProducao telaProducao;

    /**
     * Creates new form JDialogProdutos
     */
    public JDialogProdutosProducao(java.awt.Frame parent, boolean modal, JPanelProducao telaProducao) {
        super(parent, modal);
        initComponents();
        ...
        preencherProdutos();
        buscaDinamica();
        this.telaProducao = telaProducao;
    }
    ...
    private void preencherProdutos() {
        ...
        produto.buscarProdutosProducao();
